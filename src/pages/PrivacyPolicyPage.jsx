        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground mb-10">
              <strong className="text-foreground">ATL TV Mount PRO</strong> ("we," "us,"
              or "our") is committed to protecting your personal information. This Privacy
              Policy explains what information we collect, how we use it, and your rights
              regarding that information when you use our website or services.
            </p>
            ...
            <Section title="1. Information We Collect">
              ...
              <ul className="list-disc list-inside space-y-1 pl-2">
                <li>
                  ...
                  name, email address, phone number, and service address when submitting a
                  booking or quote request.
                </li>
                <li>
                  <strong className="text-foreground">Service details</strong> — the type
                  of service requested, project description, and any photos or notes you
                  choose to share.
                </li>
                <li>
                  <strong className="text-foreground">Payment information</strong> — we do
                  not store payment card details. Payments are processed through trusted
              ...
              <p>
                ...
                system, referring URLs, and pages viewed, through standard web server
            ...
            <Section title="2. How We Use Your Information">
              ...
              <ul className="list-disc list-inside space-y-1 pl-2">
                <li>Schedule, confirm, and complete your service appointments.</li>
                <li>
                ...
                <li>
                  Send newsletters or promotional offers if you have opted in (you can
            ...
            <Section title="3. Information Sharing">
              ...
              <ul className="list-disc list-inside space-y-1 pl-2">
                <li>
                  ...
                  may share necessary details with third-party tools and platforms that
                  help us operate our business (e.g., scheduling software, email
                  platforms, payment processors). These providers are contractually
                ...
                <li>
                  ...
                  the rights, property, or safety of our business, employees, or clients.
                </li>
                <li>
                  <strong className="text-foreground">Business transfers</strong> — in
                  the event of a merger, acquisition, or sale of assets, your information
                  may be transferred as part of that transaction. We will provide notice
                  before this occurs.
                </li>
              </ul>
            </Section>
            ...
            <Section title="4. Data Retention">
              ...
              <p>
                ...
                <strong className="text-foreground">3 years</strong> from the date of
                service. Newsletter subscription records are kept until you unsubscribe.
            ...
            <Section title="5. Cookies and Tracking">
              <p>
                ...
                browsing experience, remember your preferences, and gather analytics data.
                Cookies are small text files stored on your device.
              </p>
              <p>
                You can control cookie settings through your browser. Disabling cookies
                may affect some website functionality. We do not use advertising or
            ...
            <Section title="6. Data Security">
              <p>
                ...
                destruction. These measures include secure HTTPS transmission, access
                controls, and encrypted data storage.
              </p>
              <p>
                While we strive to protect your information, no method of transmission
                over the internet or electronic storage is 100% secure. We cannot
                guarantee absolute security, but we will notify you promptly in the event
            ...
            <Section title="7. Your Rights">
              ...
              <ul className="list-disc list-inside space-y-1 pl-2">
                ...
                <li>
                  <strong className="text-foreground">Opt-out</strong> — unsubscribe
                  from marketing communications at any time using the link in any email
                  we send, or by contacting us directly.
                </li>
              </ul>
              <p>
                To exercise any of these rights, contact us at the details provided in
                Section 9 below. We will respond within 30 days.
              </p>
            </Section>

            <Section title="8. Children's Privacy">
              <p>
                Our services are not directed at children under the age of 13, and we do
            ...
            <Section title="9. Changes to This Policy">
              <p>
                ...
                practices or applicable law. When we make changes, we will update the
                "Last updated" date at the top of this page. We encourage you to review
                this Policy from time to time.
              </p>
              <p>
                Continued use of our website or services after any update constitutes
            ...
            <Section title="10. Contact Us">
              <p>
                ...
                Policy or your personal information, please reach out:
              </p>
