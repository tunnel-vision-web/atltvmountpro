    ...
    <footer className="bg-muted text-muted-foreground border-t border-border">
      <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Professional TV mounting and handyman services in Atlanta metro area and throughout Georgia.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <p>Phone: <a href="tel:770-374-3203" className="hover:text-primary transition-colors duration-200">770-374-3203</a></p>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm">© 2026 ATL TV Mount PRO. All rights reserved.</p>
