...
const ClientAuthModal = () => {
  const { authModalOpen, closeAuthModal, authModalMode, setAuthModalMode } = useUI();
      ...
      <DialogContent className="w-full max-w-[420px] p-0 gap-0 overflow-hidden">
        <DialogHeader className="px-6 pt-6 pb-4 border-b border-border flex-shrink-0">
          <DialogTitle className="text-lg">
            ...
            {mode === 'signupForm' && (accountType === 'customer' ? 'Client Sign Up' : 'Technician Sign Up')}
          </DialogTitle>
          <DialogDescription className="text-sm mt-0.5">
            {mode === 'login' && 'Sign in to track your jobs and manage invoices.'}
            {mode === 'signup' && 'Join ATL TV Mount PRO to get started.'}
            {mode === 'chooseType' && 'Select the account type that best describes you.'}
            {mode === 'signupForm' && 'Fill in your details to create your account.'}
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Book services and track your jobs</p>
                </div>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-foreground">New Technician</p>
                  <p className="text-sm text-muted-foreground">Join our team and manage assignments</p>
                </div>
              </button>
              <button
                type="button"
